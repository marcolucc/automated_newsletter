...
$sql = "SELECT * FROM users WHERE newsletter=1 AND active=1";
$result = $conn->query($sql);


$sql1= "SELECT * FROM job_post ORDER BY createdat DESC";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        if($count==0){
            ...
            $row1 = $result1->fetch_assoc();
                    ...
                    $descrizione=$row1['description'];
                    $idannuncio=$row1['id_jobpost'];
                    $anniEsperienza=$row1['anniEsperienza'];
                    $contratto=$row1['contratto'];
                    $paga=$row1['paga'];
            $count=1;
        }
                    $nome=$row['firstname'];
                    ...
                    $to = $email;
                    $subject = "Nuovo lavoro per te - Upwaiter";
  ...
  <table width="100%" class="header" style="border-collapse: separate; border-spacing: 0; table-layout: fixed">
    <tr>
      <td class="logo" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; padding: 0; text-align: center" align="center">
          ...
          <img src="https://www.upwaiter.com/uploads/logo/logo.png" width="77" height="85" class="featured" style="padding: 0 0 37px">
        ...
        <table width="100%" class="content" style="border-collapse: separate; border-spacing: 0; table-layout: fixed">
          <tr>
            <td class="content-td" style="color: #818181; font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 150%; padding: 0 0 60px">
                ...
                <div class="intercom-container intercom-align-left" style="margin-top: 0; padding-left: 10%; padding-right: 10%; text-align: left !important" align="left"><img src="https://www.upwaiter.com/img/mail.png" style="margin: 13px 0; max-width: 100%; padding: 0"></div>
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; text-align: left !important" align="left"><b style="color: #606060">Hi '.$nome.'</b></p>

<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; text-align: left !important" align="left"><b style="color: #606060">A new job announcement has been posted on our site! Check it out:   </b><img src="https://js.intercom-mail-200.com/images/emojis/32x32/1f381.png" width="16" height="16" alt="gift" class="ic_emoji_img" style="height: 16px; margin: 0; max-width: 16px; min-height: 16px; padding: 0; width: 16px"><br></p>
<p class="intercom-align-left" style="font-size: 16px; margin: 0 0 13px; padding-left: 10%; padding-right: 10%; text-align: left !important" align="left">'.$descrizione.'</p>
<table class="intercom-container intercom-align-center" align="center" style="border-collapse: collapse; border-spacing: 0; margin: 18px auto; padding: 0 10%; table-layout: fixed; text-align: center !important"><tr><td style="background-color: #3090f0; border: 1px none #dadada; border-radius: 26px; font-family: Helvetica, Arial, sans-serif; font-size: 16px; margin: 0; padding: 13px 35px; text-align: left; vertical-align: top" align="left" bgcolor="#3090f0" valign="top"><a class="intercom-h2b-button" target="_blank" href="https://www.upwaiter.com/view-job-post.php?id='.$idannuncio.'" style="background-color: #3090f0; border: none; border-radius: 26px; color: white !important; display: inline-block; font-size: 15px; min-height: 20px; outline: none !important; text-decoration: none !important">Apply</a></td></tr></table>
  ...
  <p class="social" style="color: #a8a8a8; font-size: 13px; font-weight: 300; line-height: 1.5; margin: 27px 0 20px; text-decoration: none">
      ...
      <a href="https://via.intercom-mail-200.com/e?ob=ng6dpSnekA21heKjZaju4T20KTYiMtezxS4B7%2FipMZ6EKXXq%2BOEEpnYVsI%2FOYfot&h=eee880d39493026bd2d39ae3fd16d4d2770d2983-13038316923" style="border: none; color: #a8a8a8; font-size: 13px; outline: none !important; text-decoration: none"><img alt="Facebook" src="https://marketing.intercom-mail-200.com/assets/email/broadcast/facebook-2263526f2b7c7cf3c7c2a066588b01ef.png" width="60"></a>
    
    
      <a href="https://via.intercom-mail-200.com/e?ob=kesUulp6upSFZLWbXKXlYibfe2pd%2F7RGmb63Cvcz62o%3D&h=a63aa1e80c0fb25b00f64f3f01f353ee32569e22-13038316923" style="border: none; color: #a8a8a8; font-size: 13px; outline: none !important; text-decoration: none"><img alt="Twitter" src="https://marketing.intercom-mail-200.com/assets/email/broadcast/twitter-fe222f8697fa267d095338db3f583c94.png" width="60"></a>
    
  </p>
-->

          
  <p style="color: #a8a8a8; font-size: 13px; font-weight: 300; line-height: 1.5; margin: 0 0 10px; text-decoration: none">Made with ❤️ by Upwaiter</p>

          
            
              <p class="unsub" style="color: #a8a8a8; font-size: 13px; font-weight: 300; line-height: 1.5; margin: 0; text-decoration: none"><a href="https://www.upwaiter.com/unsub.php?mail='.$email.'" style="border: none; color: #a8a8a8; font-size: 13px; outline: none !important; text-decoration: underline">Unsubscribe from our emails</a></p>
...
';
                    ...
                    $headers[] = 'To: '.$to;
                    $headers[] = 'From: no-reply@upwaiter.com';
